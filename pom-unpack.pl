...
Usage:
	$0 POM-FILE
Converts a .pom file to PNG picture. The picture will have the same name as
a .pom file (except extension), or will have numbers appended to it if there
are many pictures in .pom file (hello.pom might become hello-1.png and hello-2.png).
HERE
...
my @bmps=map{
	...
	print $res pack "I3S2I6",0x7c,$width,$height,1,32,3,$width*$height*4,2835,2835,0,0;
	print $res pack "C*",
